...
static constexpr auto qt_meta_stringdata_ZN22QuickStudioApplicationE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN22QuickStudioApplicationE[] = {
...
Q_CONSTINIT const QMetaObject QuickStudioApplication::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN22QuickStudioApplicationE.offsetsAndSizes,
    qt_meta_data_ZN22QuickStudioApplicationE,
    qt_static_metacall,
    nullptr,
    qt_metaTypeArray<
        // property 'fontPath'
...
void QuickStudioApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QuickStudioApplication::*)();
            if (_q_method_type _q_method = &QuickStudioApplication::fontPathChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *QuickStudioApplication::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN22QuickStudioApplicationE.stringdata0))
